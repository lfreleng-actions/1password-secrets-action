...
// CLIClientAdapter adapts the cli.ClientInterface to implement the CLIClient interface.
type CLIClientAdapter struct {
	client cli.ClientInterface
}

// NewCLIClientAdapter creates a new adapter for the CLI client.
func NewCLIClientAdapter(client cli.ClientInterface) *CLIClientAdapter {
