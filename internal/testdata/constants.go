...
var (
	// ValidDummyToken is a properly formatted 860-character dummy token for testing.
	// This is NOT a real 1Password service account token.
	// Format: dummy_ + 854 characters = 860 total characters
	// Real tokens are 860 characters: ops_ + 856 characters
	ValidDummyToken = "dummy_" + strings.Repeat("a", 854)
