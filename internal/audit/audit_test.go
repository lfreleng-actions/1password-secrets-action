...
func TestDefaultAuditConfig(t *testing.T) {
	// Force file logging on to make test deterministic in CI
	_ = os.Setenv("OP_AUDIT_LOG_TO_FILE", "true")
	defer func() { _ = os.Unsetenv("OP_AUDIT_LOG_TO_FILE") }()
	config := DefaultAuditConfig()
...
func TestFileLogging(t *testing.T) {
	...
	config.LogToFile = true // Explicitly enable file logging for this test
