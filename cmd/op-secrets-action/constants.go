...
const (
	...
	EnvDebug               = "DEBUG"
	EnvMockMode            = "MOCK_MODE"
)

// Test token variables - using proper 860-character dummy token
// Real 1Password tokens are 860 characters long
var (
	TestValidToken = "dummy_" + strings.Repeat("a", 854)
)
