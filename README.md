...
| `cli_version` | No | `latest` | 1Password CLI version to use. When set to a specific version (e.g., 2.31.1), it must exist in the versions database; unsupported versions will fail with a clear error. |
